...
/// Diagnostic report from a rendering pass.
///
/// Contains node counts, timing, warnings, and a compatibility score.
class RenderReport {
  ...
  /// Compatibility score as a percentage.
  ///
  /// Score = (painted + recovered) / (painted + recovered + failed) × 100
  ...
  int get totalProcessed =>
      paintedNodes + skippedNodes + recoveredNodes + failedNodes;

  factory RenderReport.fromMetrics(
      int totalNodes, PaintMetrics metrics) {
    return RenderReport(
